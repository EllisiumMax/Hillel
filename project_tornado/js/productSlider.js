        ...
        if(divId) {
            ...
            for(let i = 0; i < imgArray.length; i++) {
                ...
                SLIDER_BULLET.onclick = () => {
                    counter = i;
                    if(counter >= imgArray.length - 1) SLIDER_BTN_NEXT.style.left = "3em";
                    else SLIDER_BTN_NEXT.style.left = "-4.9em";
                    if(counter <= 0) SLIDER_BTN_PREV.style.left = 0
                    else SLIDER_BTN_PREV.style.left = "4.9em";
            ...
            function next() {
                ...
                SLIDER_BTN_PREV.style.left = "4.9em";
                SLIDER_BTN_PREV.style.opacity = 0;
                SLIDER_BTN_NEXT.style.opacity = 0;
                ...
                if(counter == imgArray.length - 1) {
                    SLIDER_BTN_NEXT.style.left = "3em";
                }
                ...
                setTimeout(() => {
                    ...
                    if(imgArray[counter + 1]) {
                        ...
                        PREVIOUS_SLIDE.src = imgArray[imgArray.length - 1];
                    } else  PREVIOUS_SLIDE.src = imgArray[imgArray.length - 2];

                    allBullets[counter].style.boxShadow =
                        "0 0 10px 1px rgb(111, 0, 255)";
                    SLIDER_BTN_NEXT.onclick = next;
                }, transitionTime);
            ...
            function previous() {
                ...
                SLIDER_BTN_NEXT.style.left = "-4.9em";
                SLIDER_BTN_PREV.style.opacity = 0;
                SLIDER_BTN_NEXT.style.opacity = 0;
                allBullets[counter].style.boxShadow = "";
                ...
                setTimeout(() => {
                    ...
                    if(imgArray[counter - 1]) {
                        ...
                        if(imgArray[counter + 1]) NEXT_SLIDE.src = imgArray[counter +
                            1];
                    } else NEXT_SLIDE.src = imgArray[1];
